<%-- 
    ...
    Created on : Feb 17, 2020, 4:40:12 AM
    Author     : Fahik's PC
--%>
    ...
    <body>
        <%
                ...
                if (Email !=null && Password !=null && UserRole !=null && Address !=null && Telephone !=null && CustomerName !=null)
            {
                ...
                String Val1=("UPDATE users SET Email = '"+Email+"',Password='"+Password+"',UserRole='"+UserRole+"',Address='"+Address+"' ,Telephone='"+Telephone+"',CustomerName='"+CustomerName+"' WHERE Email='"+Email+"'");
