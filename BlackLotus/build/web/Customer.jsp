<%-- 
    Document   : Client
    Created on : Jan 12, 2020, 11:38:29 AM
    Author     : Fahik's PC
--%>
...
<html>
  ...
  <table border="0" style="float: left">
    <table border="1" width="30%" cellpadding="10px;" align='left'>
            
            <tbody>
                <tr>
                    <td><table border="1" width="50%" cellpadding="10px;" align='left'>
